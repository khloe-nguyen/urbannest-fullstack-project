...
class FavouriteTravelCard extends StatefulWidget {
  final TravelEntity travel;
  final String collectionName;

  const FavouriteTravelCard(
      {super.key, required this.travel, required this.collectionName});

  @override
  State<FavouriteTravelCard> createState() => _FavouriteTravelCardState();
}

class _FavouriteTravelCardState extends State<FavouriteTravelCard> {
                    ...
                    onTap: () async {
                      ...
                      if (getUserCubit.state is! UserSuccess) {
                        ...
                        if (getFavouriteCubit.isLoved(widget.travel.id)) {
                          ...
                          if (context.mounted) {
                            Fluttertoast.showToast(
                              msg: "Added success to ${widget.collectionName}!",
                              toastLength: Toast.LENGTH_SHORT,
                              gravity: ToastGravity.BOTTOM,
                              backgroundColor: Colors.green.shade400,
                              textColor: Colors.white,
                          ...
                          if (getUserCubit.state is UserSuccess)
                            Icon(
                              ...
                              color: getFavouriteCubit.isLoved(widget.travel.id)
                                  ...
                                  : Colors.transparent,
                              // Trong suốt khi không yêu thích
