...
export default function CustomerTrips() {
  ...
  const getUserReview = GetUserReviewRequest(currentPageReview - 1, 10, reviewStatus);
    ...
    <>
      ...
      <ContainerStyled>
        ...
        <BodyStyled>
            ...
            <>
              ...
              {getUserTrips.isSuccess && getUserTrips.data.data.length == 0 && (
                <EmptyListBooking>
                  ...
                  {status == "upcoming" && <p>You don’t have upcoming stay-in </p>}
                                    ...
                                    .map((trip, index) => {
                                      ...
                                      return (
                                        <TripStyled key={index}>
                                          <div
                                            onClick={() =>
                                              navigate("/property_detail/" + trip.property.id)
                                            }
                                          >
                                            <img src={trip.property.propertyImages[0]} />
                                            <BookingOption>
          ...
          {headerType == "refund" && (
            <>
              {getUserRefund.isSuccess && getUserRefund.data.data.length == 0 && (
                <EmptyListBooking>
                  <CiSquareInfo />
                    ...
                    if (reviewStatus == "own") {
                      return (
                        <CommentContainerStyled key={index}>
                          <div>
                            <Avatar round={15} src={review.booking.property.propertyImages[0]} />

                            {review.booking.property.user.id == user.data.data.id ? (
                              <button onClick={() => setBookingDetail(review.booking)}>
                                Booking detail
                              </button>
                            ) : (
                          ...
                          <ReviewContentStyled>
                            ...
                            <div>
                              {review.booking.property.user.id == user.data.data.id ? (
                                <p>
                                  Your review of {review.toUser.firstName} after their stay at your
                                  property
                                </p>
                              ) : (
                                <p>
                                  Your review of {review.toUser.firstName} and your experience
                          ...
                          <ReviewContentStyled>
                            ...
                            <div>
                              {review.booking.property.user.id == user.data.data.id ? (
                                ...
                                <p>
                                  This is feedback from hosts regarding my stay at their property
                                </p>
                              )}
                            </div>
                          </ReviewContentStyled>
      ...
      {bookingDetail && <BookingDetail action={() => setBookingDetail()} booking={bookingDetail} />}
